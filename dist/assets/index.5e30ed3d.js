...
class __PRIVATE_WebChannelConnection extends class __PRIVATE_RestConnection {
  ...
  vo(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, __PRIVATE_logWarn(me, `RPC '${e}' stream ${r2} transport errored:`, t2), P2.Ro(new FirestoreError(C.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = C.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P2.Ro(new FirestoreError(n3, i3)), c.close();
        } else
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(S, "4.3.2", e), registerVersion(S, "4.3.2", "esm2017");
}();
var name = "firebase";
var version = "10.5.2";
/**
...
const storeUserInfo = (info) => addDoc(collection(db, "users"), info);
function home(navigateTo2) {
  ...
  buttonLogin.addEventListener("click", () => navigateTo2("/login"));
  buttonRegister.addEventListener("click", () => navigateTo2("/register"));
  buttonGoogle.addEventListener("click", () => {
    loginGoogle().then((result) => {
      ...
      const email = error2.customData.email;
...
function login(navigateTo2) {
  ...
  newUser.classList.add("inline-text");
  ...
  errorText.textContent = "Error al ingresar a tu cuenta, revisa que tu correo y contrase\xF1a sean correctos";
  ...
  subTitleLogin.textContent = "Inicia sesi\xF3n para continuar";
  buttonLogin.textContent = "Iniciar sesi\xF3n";
  forgetPass.textContent = "\xBFOlvidaste tu contrase\xF1a?";
  newUser.textContent = "\xBFA\xFAn no tienes cuenta?";
  buttonReturn.textContent = "Atr\xE1s";
  buttonNewUser.textContent = "Create una nueva";
  buttonReturn.addEventListener("click", () => {
    navigateTo2("/");
  });
  buttonNewUser.addEventListener("click", () => navigateTo2("/register"));
  buttonLogin.addEventListener("click", (event) => {
    event.preventDefault();
    console.log("clickkkkkk");
    loginUser(inputEmail.value, inputPass.value).then((userCredential) => {
...
function register(navigateTo2) {
  ...
  whiteBackground1.classList.add("white-background1");
  whiteBackground1.style.zIndex = "0";
  section.classList.add("login-background");
  ...
  labelRegion.textContent = "Regi\xF3n:";
  labelCountry.textContent = "Pa\xEDs:";
  labelPass.textContent = "Contrase\xF1a:";
  labelPassConfirm.textContent = "Confirma contrase\xF1a:";
  inputName.placeholder = "Ejemplo: Alexis Pescoran ";
  inputEmail.placeholder = "Ejemplo: AleP@gmail.com";
  inputCountry.placeholder = "Ejemplo: Per\xFA";
  ...
  buttonRegister.addEventListener("click", (event) => {
    ...
    if (inputPass.value !== inputPassConfirm.value) {
      console.error("Las contrase\xF1as no coinciden");
      return;
    }
    registerNewUser(inputEmail.value, inputPass.value).then((userCredential) => {
      const user = userCredential.user;
      ...
      storeUserInfo(userInfo).then(() => {
        console.log(
          "Informaci\xF3n adicional del usuario almacenada en Firestore"
        );
      }).catch((error2) => {
        console.error(
          "Error al almacenar informaci\xF3n adicional del usuario en Firestore: ",
          error2
        );
      });
      navigateTo2("/wall");
...
function listenForPosts(callback) {
  const postsQuery = query(collection(db, "posts"), orderBy("timestamp", "desc"));
  return onSnapshot(postsQuery, callback);
}
const getPost = async (id2) => {
  const docSnapshot = await getDoc(doc(db, "posts", id2));
...
const updatePost = (id2, content, author, timestamp) => {
  updateDoc(doc(db, "posts", id2), { content, author, timestamp });
  console.log("cosa editada");
};
const deletePost = (id2) => {
  deleteDoc(doc(db, "posts", id2));
  console.log("cualquiercosa", id2);
};
...
function wall(navigateTo2) {
  ...
  const divLogoB = document.createElement("img");
  ...
  postArea.placeholder = "Escribe una nueva publicaci\xF3n...";
  ...
  const logout = () => {
    auth.signOut().then(() => {
      console.log("Usuario cerr\xF3 sesi\xF3n correctamente");
    }).catch((error2) => {
      console.error("Error al cerrar sesi\xF3n:", error2);
    });
  };
  ...
  function createPostElement(postData) {
    console.log("informaci\xF3n: ", postData);
    ...
    likeButton.innerHTML = "<img src=../img/likeblanco.png width = '15px' heigth='15px'>";
    const editButton = document.createElement("button");
    editButton.innerHTML = "<img src=../img/editarnegro.png width = '15px' heigth='15px'>";
    editButton.classList.add("edit-button");
    const deleteButton = document.createElement("button");
    deleteButton.classList.add("delete-button");
    deleteButton.innerHTML = "<img src=../img/borrarnegro.png width = '15px' heigth='15px'>";
